<template>
  <Head>
    ...
    <Meta name="description" content="Buat aplikasi tanpa kode program" />
  </Head>
  <section id="hero" class="bg-primarybg">
    <div
      class="container flex flex-col md:flex-row mx-3 md:mx-auto justify-center pt-32"
    >
      <div class="flex-1">
        <div class="flex flex-col gap-5 max-w-[550px]">
          ...
          <p class="text-primarytxt">
            Kamu bisa membuat aplikasi untuk bisnismu dalam hitungan menit
            dengan tanpa pengetahuan pemrograman. Nikmati pengalaman baru dalam
            membuat aplikasi tanpa code program dengan performa yang baik dan
            stabil. Penasaran?
          </p>
          <div class="mt-5">
            <NuxtLink
      ...
      <div class="flex-1 max-w-[600px] mx-8 my-16 md:mx-0 md:my-0">
    ...
    <svg
      ...
      class="custom-section-curved-top-1"
    >
      <path
        id="svg_1"
